...
# set folder ------------------------------------------------------------------
  ...
  india <- list('INDGDPNQDSMEI','INDPROMANMISMEI','INDPRMNCG02IXOBSAM','INDPRMNCG03IXOBSAM','INDPRMNIG01IXOBSAM','INDPRMNVG01IXOBSAM','INDPRMNTO01IXOBM','CCRETT01INM661N','WPIAMP01INM661N','INDWPIAMP01GPM','INDLOCOPGNOSTSAM','INDLOCOPMNOSTSAM','INDPRENEL01IXOBM','INDPRINTO01IXOBM','INDPRMITO01IXOBM','IRSTCI01INM156N','IRSTCB01INM156N','IRSTPI01INM156N','INTDSRINM193N','TRESEGINM052N','XTEXVA01INM657S','XTEITT01INM156S','EXP5330','XTIMVA01INM657S','IMP5330')
  lista <- india
