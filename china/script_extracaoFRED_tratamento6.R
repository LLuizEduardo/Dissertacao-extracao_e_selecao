...
# set folder ------------------------------------------------------------------
  ...
  china <- list('CHNGDPNQDSMEI','CHNPRCNTO01MLM','CHNPRENEL01MLM','CHNPRINTO01IXPYM','NBCNBIS','EXCHUS','CCUSMA02CNM618N','CCUSSP02CNM650N','RBCNBIS','CCRETT01CNM661N','IRSTCI01CNM156N','IRSTCB01CNM156N','INTDSRCNM193N','MYAGM2CNM189N','TRESEGCNM052N','TRESEGTWM194N','XTEXVA01CNM657S','VALEXPTWM052N','CHNXTEXVA01NCMLM','XTEITT01CNM156S','EXPCH','VALIMPTWM052N','XTIMVA01CNM657S','CHNXTIMVA01NCMLM','IMPCH')
  lista <- china
