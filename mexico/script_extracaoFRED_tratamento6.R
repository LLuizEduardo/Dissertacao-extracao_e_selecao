...
# set folder ------------------------------------------------------------------
  ...
  mexico <- list('NGDPRSAXDCMXQ','MEXCPIHOUMINMEI','OPCNSH01MXM661N','BSCURT02MXM160S','BSCICP02MXM460S','BSCICP03MXM665S','BSFGLV02MXM460S','BSPRTE02MXM460S','MEXPPDMMINMEI','LCEAMN01MXM661S','MEXLCEAMN01GPSAM','LCEAMN03MXM661S','HOHWMN03MXM661N','PIEAFD02MXM661N','PIEAMP02MXM659N','MEXPIEAFD02GPM','MEXPIEAMP02GPM','MEXPROMANMISMEI','MEXPRMNTO01GPSAM','LCEAMN04MXM661N','MEXLOCOBPNOSTSAM','MEXLOCOBPORSTSAM','MEXPROCONMISMEI','MEXPRCNTO01GPSAM','MEXPRENTO01IXOBSAM','MEXPRINTO01GPSAM','MEXPRINTO02IXOBSAM','MEXPRMITO01IXOBSAM','MEXCPGRLH01IXOBM','MEXCPGRSE01IXOBM','LRHUTTTTMXM156S','MEXLOCOEMNOSTSAM','MEXLOCOEMORSTM','NBMXBIS','EXMXUS','CCUSMA02MXM661N','RBMXBIS','CCRETT01MXM661N','RNMXBIS','CCUSSP01MXM650N','CPGRLE01MXM657N','IR3TIB01MXM156N','IR3TTS01MXM156N','IRSTCI01MXM156N','INTGSTMXM193N','IRLTST01MXM156N','TRESEGMXM052N','XTEXVA01MXM657S','MEXXTEXVA01NCMLM','EXPMX','XTIMVA01MXM657S','MEXXTIMVA01NCMLM','MAUISA','IMPMX')
  lista <- mexico
...
c<-getSymbols(lista[[1]], src = 'FRED', env = NULL)
  ...
  c[,2]<-as.double(c[,2])
    ...
    #monthly extract
f<-getSymbols(lista[[4]], src = 'FRED', env = NULL)
...
t<-c('BSCURT02MXM160S','BSFGLV02MXM460S','BSPRTE02MXM460S','MEXLCEAMN01GPSAM','PIEAMP02MXM659N','MEXPIEAFD02GPM','MEXPIEAMP02GPM','MEXPRMNTO01GPSAM','MEXLOCOBPORSTSAM','MEXPRCNTO01GPSAM','MEXPRINTO01GPSAM','LRHUTTTTMXM156S','MEXLOCOEMORSTM','CPGRLE01MXM657N','IR3TIB01MXM156N','IR3TTS01MXM156N','IRSTCI01MXM156N','INTGSTMXM193N','IRLTST01MXM156N','XTEXVA01MXM657S','XTIMVA01MXM657S'
)
