...
# set folder ------------------------------------------------------------------
  ...
  israel <- list('ISRGDPNQDSMEI','ISRCPIHOUMINMEI','ISRCPISXHMINMEI','ISRPERMITMISMEI','ISRPPDMMINMEI','LCEAMN01ILM657S','PIEAMP02ILM659N','ISRPIEAMP02GPM','ISRPROMANMISMEI','ISRPRMNTO01GPSAM','ISRPRINTO01GPSAM','ISRCP040400IXOBM','ISRCP120000GPM','ISRCPGRLH01IXOBM','ISRCPGRSE01IXOBM','NBILBIS','CCUSMA02ILM618N','CCUSSP02ILM650N','RBILBIS','CCRETT01ILM661N','CPGRLE01ILM657N','IR3TIB01ILM156N','IRSTCI01ILM156N','IRLTLT01ILM156N','XTEXVA01ILM667S','ISRXTEXVA01GPSAM','EXP5081','XTIMVA01ILM667S','ISRXTIMVA01GPSAM','IMP5081')
  lista <- israel
...
t<-c('LCEAMN01ILM657S','PIEAMP02ILM659N','ISRPIEAMP02GPM','ISRPRMNTO01GPSAM','ISRPRINTO01GPSAM','ISRCP120000GPM','CPGRLE01ILM657N','IR3TIB01ILM156N','IRSTCI01ILM156N','IRLTLT01ILM156N','ISRXTEXVA01GPSAM','ISRXTIMVA01GPSAM'
)
